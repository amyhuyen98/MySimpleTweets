...
public class TwitterClient extends OAuthBaseClient {
	...
	public void sendTweet(String message, AsyncHttpResponseHandler handler){
		...
		// Can specify query string directly or through RequestParams
		RequestParams params = new RequestParams();
		params.put("status", message);
		client.post(apiUrl, params, handler);
	}

	public void replyTweet(String message, String tweetId, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/update.json");
		RequestParams params = new RequestParams();
		params.put("status", message);
	...
	public void retweet(String tweetId, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl(String.format("status/update/%s.json", tweetId));
		RequestParams params = new RequestParams();
